...
DesktopWidget 支持用户创建和导入自定义主题。

如果你想制作自己的主题，可以参考：

➡️ **[主题制作开发指南](docs/THEME_DEV_GUIDE.md)**
...
DesktopWidget 不要求用户注册账号，也不会收集姓名、邮箱、个人文件、密码或私人内容等个人信息。

为了改进软件稳定性和用户体验，DesktopWidget 可能会收集有限的匿名技术和使用统计数据，例如：
...
部分网络信息可能用于生成匿名国家/地区统计数据。该信息仅用于了解软件使用分布情况，不会存储用户 IP 地址，也不会收集精确位置。
...
DesktopWidget 不会出售或用于广告目的共享用户数据。

完整隐私政策：

https://github.com/你的用户名/DesktopWidget/blob/main/PRIVACY.md
