...
![预览图](https://raw.githubusercontent.com/Cherish95279/DesktopWidget/main/screenshots/preview1.1.9.png)
...
📸 预览图
https://raw.githubusercontent.com/Cherish95279/DesktopWidget/main/screenshots/preview1.1.9.png
...
1. 将上面的内容复制，替换你的 `README.md` 文件
2. 提交并推送：

```bash
git add README.md
git commit -m "docs: 更新README到v1.1.9"
git push
